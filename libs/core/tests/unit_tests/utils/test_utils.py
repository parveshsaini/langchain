...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Differing booleans use last-wins instead of being summed into an int
        # (`bool` is a subclass of `int`). See test_merge_dicts_bool for the
        # accompanying type-preservation assertions.
